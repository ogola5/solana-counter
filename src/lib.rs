...
mod test {
    ...
    fn test_counter() {
        ...
        let increment_instruction_data: Vec<u8> = vec![0, 2, 0, 0, 0]; // 2 is the increment value
        let decrement_instruction_data: Vec<u8> = vec![1, 3, 0, 0, 0]; // 3 is the decrement value
